...
describe('Service Tests', () => {
    ...
    describe('Aufnahme Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AufnahmeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/aufnahmes';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Aufnahme', () => {

                let entity: Aufnahme;
                service.find(123).subscribe((_entity: Aufnahme) => {
                    entity = _entity;
                });
