...
import de.ml.hipmediadb.config.audit.AuditEventConverter;
import de.ml.hipmediadb.domain.PersistentAuditEvent;
...
import static de.ml.hipmediadb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
