...
import de.ml.hipmediadb.repository.PersonRepository;
...
public class PersonResourceIntTest {
    ...
    private static final String DEFAULT_PCLASS = "AAAAAAAAAA";
    private static final String UPDATED_PCLASS = "BBBBBBBBBB";

    private static final String DEFAULT_LEBENSDATEN = "AAAAAAAAAA";
    private static final String UPDATED_LEBENSDATEN = "BBBBBBBBBB";
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person()
            ...
            .pclass(DEFAULT_PCLASS)
            .lebensdaten(DEFAULT_LEBENSDATEN);
        return person;
    }
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getPclass()).isEqualTo(DEFAULT_PCLASS);
        assertThat(testPerson.getLebensdaten()).isEqualTo(DEFAULT_LEBENSDATEN);
    }
    ...
    public void getAllPeople() throws Exception {
        ...
        restPersonMockMvc.perform(get("/api/people?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pclass").value(hasItem(DEFAULT_PCLASS.toString())))
            .andExpect(jsonPath("$.[*].lebensdaten").value(hasItem(DEFAULT_LEBENSDATEN.toString())));
    }
    ...
    public void getPerson() throws Exception {
        ...
        restPersonMockMvc.perform(get("/api/people/{id}", person.getId()))
            ...
            .andExpect(jsonPath("$.pclass").value(DEFAULT_PCLASS.toString()))
            .andExpect(jsonPath("$.lebensdaten").value(DEFAULT_LEBENSDATEN.toString()));
    }
    ...
    public void updatePerson() throws Exception {
        ...
        updatedPerson
            ...
            .pclass(UPDATED_PCLASS)
            .lebensdaten(UPDATED_LEBENSDATEN);
        ...
        assertThat(testPerson.getPclass()).isEqualTo(UPDATED_PCLASS);
        assertThat(testPerson.getLebensdaten()).isEqualTo(UPDATED_LEBENSDATEN);
    }
